...
vcom -explicit  -93 "./src/touch/touch_ctrl.vhd"
vcom -explicit  -2002 "./tbs/touch/touch_ctrl_tb.vhd"

#Run simulation
vsim -novopt -t ps +notimingchecks work.touch_ctrl_tb

#Add waves
add wave -position insertpoint sim:/touch_ctrl_tb/uut/*
add wave -position insertpoint sim:/touch_ctrl_tb/uut/spi_master_inst/*
