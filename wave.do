...
add wave -noupdate -group tft /top_tb/uut/tft_inst/x
add wave -noupdate -group tft /top_tb/uut/tft_inst/y
add wave -noupdate -expand -group tft_reader_fifo -radix decimal /top_tb/uut/tft_inst/tft_ddr2_reader_inst/tft_fifo_inst/wr_addr
add wave -noupdate -expand -group tft_reader_fifo -radix decimal /top_tb/uut/tft_inst/tft_ddr2_reader_inst/tft_fifo_inst/rd_addr
add wave -noupdate -expand -group tft_reader_fifo /top_tb/uut/tft_inst/tft_ddr2_reader_inst/tft_fifo_inst/fifo_s_tvalid
add wave -noupdate -expand -group tft_reader_fifo /top_tb/uut/tft_inst/tft_ddr2_reader_inst/tft_fifo_inst/fifo_m_tvalid
add wave -noupdate -expand -group tft_reader_fifo /top_tb/uut/tft_inst/tft_ddr2_reader_inst/tft_fifo_inst/in_tvalid
add wave -noupdate -expand -group tft_reader_fifo /top_tb/uut/tft_inst/tft_ddr2_reader_inst/tft_fifo_inst/in_tready
add wave -noupdate -expand -group tft_reader_fifo /top_tb/uut/tft_inst/tft_ddr2_reader_inst/tft_fifo_inst/out_tvalid
add wave -noupdate -expand -group tft_reader_fifo /top_tb/uut/tft_inst/tft_ddr2_reader_inst/tft_fifo_inst/out_tready
add wave -noupdate -expand -group tft_reader_fifo /top_tb/uut/tft_inst/tft_ddr2_reader_inst/tft_fifo_inst/out_tdata
add wave -noupdate -expand -group tft_reader_fifo /top_tb/uut/tft_inst/tft_ddr2_reader_inst/tft_fifo_inst/fifo_is_empty
add wave -noupdate -expand -group tft_reader_fifo /top_tb/uut/tft_inst/tft_ddr2_reader_inst/tft_fifo_inst/fifo_is_full
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {30068624 ps} 0}
...
update
WaveRestoreZoom {29910937 ps} {30239063 ps}
